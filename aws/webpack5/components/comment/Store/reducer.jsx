...
const reducer = (state,action) => {
    switch(action.type){
        ...
        case "PATCH_COMMENT_SUCCESS":
            ...
            console.log('patch dd :',state.commentItem)
            const item = commentItem.map( obj => {
                // return obj.id === index
                if(obj.id === index ){
                    return {...obj,content}
                } else {
            ...
            // console.log('example : ',content,index,state.commentItem[index])
            return {
                ...state,
                commentItem:item
            }
        case "PATCH_COMMENT_ERROR":
            return {
                ...state,
                loadding:false,
                error:action.payload
        ...
        case "DELETE_COMMENT_SUCCESS":
            return {
                ...state,
                commentItem:[...state.commentItem.filter( (v,k)=> action.payload !== v.id ) ]
            }
        ...
        case "UPDATE":
            ...
            // let {content,index} = action.payload
            // state.commentItem[index] = content
            // console.log('example : ',content,index,state.commentItem[index])
            // return {
            //     ...state,
            //     commentItem
